...
<!-- Animated text -->
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com/?color=FF00FF&size=35&center=true&width=290&lines=HELLO;WORLD"/>
</div>

<h2 align="right">1.1. INTRODUCTION 📰</h2>

This is my first Git repository, where you'll find a simple HTML file called index.html. In this file, you'll see the classic "Hello, World!" greeting as an initial way to explore the Git environment.

<h2 align="right">1.2. DESCRIPTION 📝</h2>

This simple repository was created as part of my initial journey into learning programming and using Git for version control. The highlight of this repository is the index.html file, which contains the basic implementation of the famous "Hello, World!" in HTML.
